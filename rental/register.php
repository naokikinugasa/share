...
<div class="container" style="background: #EEEEEE;  border: solid white;">
	...
	<form  method="post" action="">
		...
		<input class="loginform" type="text" name="nickname" placeholder="公開" ><?php if($error['nickname'] == 'blank'){?>
			<p>ニックネームを入力してください</p><?php
		}?><br>
		<p>メールアドレス</p>
		<input class="loginform" type="text" name="email" placeholder="非公開" ><?php if($error['email'] == 'blank'){?>
			<p>メールアドレスを入力してください</p><?php
		}?><br>
		<p>パスワード</p>
		<input class="loginform" type="text" name="password" placeholder="非公開　6文字以上" ><?php if($error['password'] == 'blank'){?>
