...
<div id="howto">
<img src="/share/rental/images/howto.png" alt="" width="100%" height="100%;" />
</div>
...
<div id="char">
    <h2>ーレンタルのしかたー(パターン1)</h2>
        <div class="topNaviColumn">
        	<h2>1.商品を探す</h2>
                <div class="topNaviPhoto"><img src="/share/rental/images/projector3.jpg" alt="" /></div>
                <div class="topNaviDetail">レンタルしたい商品を商品一覧から探します。</div>
        </div><!-- /.topNaviColumn --></a>
        <div class="topNaviColumn">
            <h2>2.メッセージを送る</h2>
                <div class="topNaviPhoto"><img src="/share/rental/images/msg2.jpg" alt="" /></div>
                <div class="topNaviDetail">レンタルしたい商品が見つかったら、出品者にメッセージを送って日時・レンタル期間・受け渡し場所を決めます。</div>
        </div><!-- /.topNaviColumn -->
        <div class="topNaviColumn">
            <h2>3.レンタルする</h2>
                <div class="topNaviPhoto"><img src="/share/rental/images/watasu.png" alt="" /></div>
                <div class="topNaviDetail">メッセージで決めておいた場所に行って、出品者から商品を受け取り、料金を支払いましょう。</div>
        </div><!-- /.topNaviColumn -->
    <h2>ー出品のしかたー</h2>
        <div class="topNaviColumn">
            <h2>1.出品登録</h2>
                <div class="topNaviPhoto"><img src="/share/rental/images/syuppin.jpg" alt="" /></div>
        ...
        <div class="topNaviColumn">
            <h2>3.シェアする</h2>
                <div class="topNaviPhoto"><img src="/share/rental/images/watasu2.png" alt="" /></div>
...
<div id="char">
    <h2>ーレンタルのしかた(パターン2)ー</h2>
        ...
        <div class="topNaviColumn">
            <h2>2.予約する</h2>
                <div class="topNaviPhoto"><img src="/share/rental/images/7b55d33ec62f13f5fe460afbd8f7f70d.jpg" alt="" /></div>
                <div class="topNaviDetail">レンタル可能日から予約します。</div>
        </div><!-- /.topNaviColumn -->
        <div class="topNaviColumn">
            <h2>3.レンタルする</h2>
                <div class="topNaviPhoto"><img src="/share/rental/images/detail_image.jpg" alt="" /></div>
