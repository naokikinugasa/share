    ...
    <p style="padding: 10px;">Share(シェア)は買ってみたけど数回しか使わないモノや、買うまではいかないけど１回だけ使ってみたいモノを個人間でレンタルしあうサービスです。</p>
            ...
            <div class="topNaviColumn">
            	<h3>1.低価格で使える</h3>
                    ...
                    <div class="topNaviDetail">高くて買えなかったものをレンタルして使おう。<a class="myButtonlog3" href="products.php">商品を見る</a></div>
            </div><!-- /.topNaviColumn --></a>
            <div class="topNaviColumn">
                <h3>2.出品でお小遣い稼ぎ</h3>
                    <div class="topNaviPhoto"><img src="images/placeit.jpg" alt="" /></div>
                    <div class="topNaviDetail">買ったけど使ってないものをシェアしてお小遣いを稼ごう。<a class="myButtonlog3" href="exhit.php">シェアする</a></div>
            </div><!-- /.topNaviColumn -->
            <div class="topNaviColumn">
                <h3>3.必要最低限の生活を</h3>
                    <div class="topNaviPhoto"><img src="images/heya2.jpg" alt="" /></div>
                    <div class="topNaviDetail">必要最低限のモノしかないきれいな部屋で快適に過ごそう。<a class="myButtonlog3" href="howto.php">使い方</a></div>
            </div><!-- /.topNaviColumn -->
</div>
</div>
<!--
